...
from idfy_sdk.services.identification import models as models
...
class IdentificationService(IdfyBaseService):
    ...
    def list_log_entries(
        ...
        if threaded:
            ...
            return loop.run_in_executor(None, functools.partial(self.Get, url, model=models.ListResultIdentificationLogItem, params=params))
        return self.Get(url, model=models.ListResultIdentificationLogItem, params=params)
