...
class UpdateOauthAPIClientRequest(object):
    ...
    def __init__(self, account_id=None, client_id=None, client_name=None, enabled=None, client_secrets=None, flow=None, allowed_scopes=None, identity_token_lifetime=None, access_token_lifetime=None, absolute_refresh_token_lifetime=None, sliding_refresh_token_lifetime=None, refresh_token_usage=None, update_access_token_claims_on_refresh=None, refresh_token_expiration=None, access_token_type=None, always_send_client_claims=None, allowed_cors_origins=None):
    ...
    @property
    def flow(self):
        """Gets the flow of this UpdateOauthAPIClientRequest.


        :return: The flow of this UpdateOauthAPIClientRequest.
        :rtype: str
        """
        return self._flow
    ...
    @flow.setter
    def flow(self, flow):
        """Sets the flow of this UpdateOauthAPIClientRequest.


        :param flow: The flow of this UpdateOauthAPIClientRequest.
        :type: str
        """
    ...
    def identity_token_lifetime(self):
        """Gets the identity_token_lifetime of this UpdateOauthAPIClientRequest.

        Lifetime of identity token in seconds (defaults to 300 seconds / 5 minutes)

        :return: The identity_token_lifetime of this UpdateOauthAPIClientRequest.
        :rtype: int
        """
    ...
    def identity_token_lifetime(self, identity_token_lifetime):
        """Sets the identity_token_lifetime of this UpdateOauthAPIClientRequest.

        Lifetime of identity token in seconds (defaults to 300 seconds / 5 minutes)

        :param identity_token_lifetime: The identity_token_lifetime of this UpdateOauthAPIClientRequest.
        :type: int
        """
    ...
    def always_send_client_claims(self):
        """Gets the always_send_client_claims of this UpdateOauthAPIClientRequest.

        Gets or sets a value indicating whether client claims should be always included in the access tokens - or only for client credentials flow.

        :return: The always_send_client_claims of this UpdateOauthAPIClientRequest.
        :rtype: bool
        """
    ...
    def always_send_client_claims(self, always_send_client_claims):
        """Sets the always_send_client_claims of this UpdateOauthAPIClientRequest.

        Gets or sets a value indicating whether client claims should be always included in the access tokens - or only for client credentials flow.

        :param always_send_client_claims: The always_send_client_claims of this UpdateOauthAPIClientRequest.
        :type: bool
        """
