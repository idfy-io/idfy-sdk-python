...
from idfy_sdk.services.admin import models as models
...
class AdminService(IdfyBaseService):
    ...
    def list_accounts(self,
        ...
        if threaded:
            ...
            return loop.run_in_executor(None, functools.partial(self.Get, url, model=List[models.AccountListItem], params=params))
        return self.Get(url, model=List[models.AccountListItem], params=params)
    ...
    def list_account_names(self, threaded=False):
        ...
        if threaded:
            ...
            return loop.run_in_executor(None, functools.partial(self.Get, url, model=List[models.AccountNameItem]))
        return self.Get(url, model=List[models.AccountNameItem])
    ...
    def list_accounts_for_dealer(self, dealer_id, threaded=False):
        ...
        if threaded:
            ...
            return loop.run_in_executor(None, functools.partial(self.Get, url, model=List[models.AccountListItem]))
        return self.Get(url, model=List[models.AccountListItem])
    ...
    def list_transactions(self,
        ...
        if threaded:
            ...
            return loop.run_in_executor(None, functools.partial(self.Get, url, model=List[models.Transaction], params=params))
        return self.Get(url, model=List[models.Transaction], params=params)
    ...
    def list_templates(self, threaded=False):
        ...
        if threaded:
            ...
            return loop.run_in_executor(None, functools.partial(self.Get, url, model=List[models.PdfTemplateListItem]))
        return self.Get(url, model=List[models.PdfTemplateListItem])
