...
class DocumentSignature(object):
    ...
    def __init__(self, signature_method=None, full_name=None, first_name=None, last_name=None, middle_name=None, signed_time=None, date_of_birth=None, signature_method_unique_id=None, social_security_number=None, client_ip=None, mechanism=None, personal_info_origin=None):
    ...
    @property
    def mechanism(self):
        """Gets the mechanism of this DocumentSignature.

        The signature mechanism used

        :return: The mechanism of this DocumentSignature.
        :rtype: str
        """
    ...
    def mechanism(self, mechanism):
        """Sets the mechanism of this DocumentSignature.

        The signature mechanism used

        :param mechanism: The mechanism of this DocumentSignature.
        :type: str
        """
    ...
    def personal_info_origin(self):
        """Gets the personal_info_origin of this DocumentSignature.

        The origin of the signer name and date of birth in this object

        :return: The personal_info_origin of this DocumentSignature.
        :rtype: str
        """
    ...
    def personal_info_origin(self, personal_info_origin):
        """Sets the personal_info_origin of this DocumentSignature.

        The origin of the signer name and date of birth in this object

        :param personal_info_origin: The personal_info_origin of this DocumentSignature.
        :type: str
        """
