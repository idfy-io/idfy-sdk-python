...
class SignerResponse(object):
    ...
    def __init__(self, id=None, url=None, document_signature=None, links=None, external_signer_id=None, redirect_settings=None, signature_type=None, signer_info=None, authentication=None, extra_info=None, ui=None, notifications=None, tags=None, order=None, required=None, sign_url_expires=None, get_social_security_number=None):
    ...
    def get_social_security_number(self):
        """Gets the get_social_security_number of this SignerResponse.
        ...
        :return: The get_social_security_number of this SignerResponse.
        :rtype: bool
        """
    ...
    def get_social_security_number(self, get_social_security_number):
        """Sets the get_social_security_number of this SignerResponse.

        Get social security number for this signer only (The global variable advanced.getSocialSecurityNumber will ovveride this when sat to true).  Requires certificate with permission to retrieve social security number

        :param get_social_security_number: The get_social_security_number of this SignerResponse.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SignerResponse):
            return False
