...
class Error(object):
    ...
    def eid_error_message(self):
        """Gets the eid_error_message of this Error.

        Eid provider error message

        :return: The eid_error_message of this Error.
        :rtype: str
        """
    ...
    def eid_error_message(self, eid_error_message):
        """Sets the eid_error_message of this Error.

        Eid provider error message

        :param eid_error_message: The eid_error_message of this Error.
        :type: str
        """
    ...
    def eid_error_code(self):
        """Gets the eid_error_code of this Error.

        Eid provider error code

        :return: The eid_error_code of this Error.
        :rtype: str
        """
    ...
    def eid_error_code(self, eid_error_code):
        """Sets the eid_error_code of this Error.

        Eid provider error code

        :param eid_error_code: The eid_error_code of this Error.
        :type: str
        """
