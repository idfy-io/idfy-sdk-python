...
class MerchantSignTransaction(object):
    ...
    def __init__(self, id=None, account_id=None, audit_log_reference=None, external_reference=None, oauth_client_id=None, ip_address=None, xslt=None, data_to_sign=None, result=None, certificate=None, time_stamp=None, signed_document_id=None, pades_created=None, pades_retrieved=None, pades_deleted=None):
