...
from idfy_sdk.services.merchantsign import models as models
...
class MerchantSignService(IdfyBaseService):
    ...
    def list_transactions(self, 
        ...
        if threaded:
            ...
            return loop.run_in_executor(None, functools.partial(self.Get, url, model=List[models.MerchantSignTransaction], params=params))
        return self.Get(url, model=List[models.MerchantSignTransaction], params=params)
