...
class CreatePdfTemplate(object):
    ...
    @property
    def time_zone(self):
        """Gets the time_zone of this CreatePdfTemplate.  
        ...
        :return: The time_zone of this CreatePdfTemplate.  
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """Sets the time_zone of this CreatePdfTemplate.

        The time zone that is used for displaying signing time in the PADES (See: https://support.microsoft.com/en-us/help/973627/microsoft-time-zone-index-values for valid values) Defaults to W. Europe Standard Time  

        :param time_zone: The time_zone of this CreatePdfTemplate.  
        :type: str
        """
    ...
    def logo_source_url(self):
        """Gets the logo_source_url of this CreatePdfTemplate.  

        Url to the logo that you want to use in your template  

        :return: The logo_source_url of this CreatePdfTemplate.  
        :rtype: str
        """
    ...
    def logo_source_url(self, logo_source_url):
        """Sets the logo_source_url of this CreatePdfTemplate.

        Url to the logo that you want to use in your template  

        :param logo_source_url: The logo_source_url of this CreatePdfTemplate.  
        :type: str
        """
