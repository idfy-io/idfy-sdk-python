...
class PersonMeldinger(object):
    ...
    def meldings_kode_field(self):
        """Gets the meldings_kode_field of this PersonMeldinger.  


        :return: The meldings_kode_field of this PersonMeldinger.  
        :rtype: int
        """
    ...
    def meldings_kode_field(self, meldings_kode_field):
        """Sets the meldings_kode_field of this PersonMeldinger.


        :param meldings_kode_field: The meldings_kode_field of this PersonMeldinger.  
        :type: int
        """
    ...
    def meldings_tekst_field(self):
        """Gets the meldings_tekst_field of this PersonMeldinger.  


        :return: The meldings_tekst_field of this PersonMeldinger.  
        :rtype: str
        """
    ...
    def meldings_tekst_field(self, meldings_tekst_field):
        """Sets the meldings_tekst_field of this PersonMeldinger.


        :param meldings_tekst_field: The meldings_tekst_field of this PersonMeldinger.  
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PersonMeldinger):
            return False
