...
class PersonVervData(object):
    ...
    def verv_kode_field(self):
        """Gets the verv_kode_field of this PersonVervData.  


        :return: The verv_kode_field of this PersonVervData.  
        :rtype: str
        """
    ...
    def verv_kode_field(self, verv_kode_field):
        """Sets the verv_kode_field of this PersonVervData.


        :param verv_kode_field: The verv_kode_field of this PersonVervData.  
        :type: str
        """
    ...
    def verv_tekst_field(self):
        """Gets the verv_tekst_field of this PersonVervData.  


        :return: The verv_tekst_field of this PersonVervData.  
        :rtype: str
        """
    ...
    def verv_tekst_field(self, verv_tekst_field):
        """Sets the verv_tekst_field of this PersonVervData.


        :param verv_tekst_field: The verv_tekst_field of this PersonVervData.  
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PersonVervData):
            return False
