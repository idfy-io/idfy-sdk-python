...
class PersonEiendomNorge(object):
    ...
    def svar_eiendom_norge_field(self):
        """Gets the svar_eiendom_norge_field of this PersonEiendomNorge.  


        :return: The svar_eiendom_norge_field of this PersonEiendomNorge.  
        :rtype: str
        """
    ...
    def svar_eiendom_norge_field(self, svar_eiendom_norge_field):
        """Sets the svar_eiendom_norge_field of this PersonEiendomNorge.


        :param svar_eiendom_norge_field: The svar_eiendom_norge_field of this PersonEiendomNorge.  
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PersonEiendomNorge):
            return False
