...
class UpdateSignerRequestWrapper(object):
    ...
    def external_signer_id(self):
        """Gets the external_signer_id of this UpdateSignerRequestWrapper.  

        Your reference for the signer.  

        :return: The external_signer_id of this UpdateSignerRequestWrapper.  
        :rtype: str
        """
    ...
    def external_signer_id(self, external_signer_id):
        """Sets the external_signer_id of this UpdateSignerRequestWrapper.

        Your reference for the signer.  

        :param external_signer_id: The external_signer_id of this UpdateSignerRequestWrapper.  
        :type: str
        """
    ...
    def redirect_settings(self):
        """Gets the redirect_settings of this UpdateSignerRequestWrapper.  

        Return URLs and domain settings  

        :return: The redirect_settings of this UpdateSignerRequestWrapper.  
    ...
    def redirect_settings(self, redirect_settings):
        """Sets the redirect_settings of this UpdateSignerRequestWrapper.

        Return URLs and domain settings  

        :param redirect_settings: The redirect_settings of this UpdateSignerRequestWrapper.  
    ...
    def signature_type(self):
        """Gets the signature_type of this UpdateSignerRequestWrapper.  


        :return: The signature_type of this UpdateSignerRequestWrapper.  
        :rtype: SignatureType
        """
    ...
    def signature_type(self, signature_type):
        """Sets the signature_type of this UpdateSignerRequestWrapper.


        :param signature_type: The signature_type of this UpdateSignerRequestWrapper.  
        :type: SignatureType
        """
    ...
    def signer_info(self):
        """Gets the signer_info of this UpdateSignerRequestWrapper.  

        Define the signers name, mobile and email if you are using notifications  

        :return: The signer_info of this UpdateSignerRequestWrapper.  
        :rtype: SignerInfo
        """
    ...
    def signer_info(self, signer_info):
        """Sets the signer_info of this UpdateSignerRequestWrapper.

        Define the signers name, mobile and email if you are using notifications  

        :param signer_info: The signer_info of this UpdateSignerRequestWrapper.  
        :type: SignerInfo
        """
    ...
    def authentication(self):
        """Gets the authentication of this UpdateSignerRequestWrapper.  

        Do you want the signer to authenticate before they can see the document?  

        :return: The authentication of this UpdateSignerRequestWrapper.  
    ...
    def authentication(self, authentication):
        """Sets the authentication of this UpdateSignerRequestWrapper.

        Do you want the signer to authenticate before they can see the document?  

        :param authentication: The authentication of this UpdateSignerRequestWrapper.  
        :type: Authentication
        """
    ...
    @property
    def extra_info(self):
        """Gets the extra_info of this UpdateSignerRequestWrapper.  

        Coming soon: Do you want to collect extra info about this specific signer? (for example personal information)  

        :return: The extra_info of this UpdateSignerRequestWrapper.  
    ...
    def extra_info(self, extra_info):
        """Sets the extra_info of this UpdateSignerRequestWrapper.

        Coming soon: Do you want to collect extra info about this specific signer? (for example personal information)  

        :param extra_info: The extra_info of this UpdateSignerRequestWrapper.  
    ...
    @property
    def ui(self):
        """Gets the ui of this UpdateSignerRequestWrapper.  


        :return: The ui of this UpdateSignerRequestWrapper.  
        :rtype: UI
        """
        return self._ui
    ...
    @ui.setter
    def ui(self, ui):
        """Sets the ui of this UpdateSignerRequestWrapper.


        :param ui: The ui of this UpdateSignerRequestWrapper.  
        :type: UI
        """
    ...
    def notifications(self):
        """Gets the notifications of this UpdateSignerRequestWrapper.  


        :return: The notifications of this UpdateSignerRequestWrapper.  
        :rtype: Notifications
        """
    ...
    def notifications(self, notifications):
        """Sets the notifications of this UpdateSignerRequestWrapper.


        :param notifications: The notifications of this UpdateSignerRequestWrapper.  
        :type: Notifications
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this UpdateSignerRequestWrapper.  

        Coming soon.  

        :return: The tags of this UpdateSignerRequestWrapper.  
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this UpdateSignerRequestWrapper.

        Coming soon.  

        :param tags: The tags of this UpdateSignerRequestWrapper.  
        :type: list[str]
        """
    ...
    @property
    def order(self):
        """Gets the order of this UpdateSignerRequestWrapper.  

        Optional order of signing for the signer.  

        :return: The order of this UpdateSignerRequestWrapper.  
        :rtype: int
        """
        return self._order
    ...
    def order(self, order):
        """Sets the order of this UpdateSignerRequestWrapper.

        Optional order of signing for the signer.  

        :param order: The order of this UpdateSignerRequestWrapper.  
        :type: int
        """
    ...
    @property
    def required(self):
        """Gets the required of this UpdateSignerRequestWrapper.  
        ...
        :return: The required of this UpdateSignerRequestWrapper.  
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this UpdateSignerRequestWrapper.

        Determines if the signer is required to sign the document before other signers. Any other signers will not be allowed to sign before all required signers have signed the document.  

        :param required: The required of this UpdateSignerRequestWrapper.  
        :type: bool
        """
    ...
    def sign_url_expires(self):
        """Gets the sign_url_expires of this UpdateSignerRequestWrapper.  
        ...
        :return: The sign_url_expires of this UpdateSignerRequestWrapper.  
        :rtype: datetime
        """
    ...
    def sign_url_expires(self, sign_url_expires):
        """Sets the sign_url_expires of this UpdateSignerRequestWrapper.

        The time at which the signature URL expires (ISO 8601). Specify this if you want a limited time-to-live for the URL. Defaults to the lifetime of the document.  

        :param sign_url_expires: The sign_url_expires of this UpdateSignerRequestWrapper.  
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSignerRequestWrapper):
            return False
